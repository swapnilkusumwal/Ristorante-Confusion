            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            India<br />
                            <i className="fa fa-phone"></i>: +91-8765516920<br />
                            <i className="fa fa-envelope"></i>: <a href="mailto:swpanilkusumwal@gmail.com">swpanilkusumwal@gmail.com</a>
                            </address>
                    </div>
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            <a role="button" className="btn btn-primary" href="tel:+85212345678"><i className="fa fa-phone"></i> Call</a>
                            <a role="button" className="btn btn-info" href="skype:swapnil.kusumwal?call"><i className="fa fa-skype"></i> Skype</a>
